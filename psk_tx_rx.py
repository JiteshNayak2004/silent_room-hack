...
class psk_tx_rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "psk_tx_rx")
        ...
        self.iio_pluto_source_0.set_frequency(600000000)
        self.iio_pluto_source_0.set_samplerate(70000)
        ...
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_ff(50)
        ...
        self.connect((self.blocks_throttle_1, 0), (self.blocks_uchar_to_float_1, 0))
        ...
        self.connect((self.digital_psk_demod_0, 0), (self.blocks_throttle_1, 0))
        self.connect((self.iio_pluto_source_0, 0), (self.digital_psk_demod_0, 0))
...
def main(top_block_cls=psk_tx_rx, options=None):
